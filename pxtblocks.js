...
(function (pxtblockly) {
    ...
    var FieldCustomMelody = /** @class */ (function (_super) {
        ...
        FieldCustomMelody.prototype.parseTypeScriptValue = function (value) {
            ...
            try {
                ...
                for (var j = 0; j < notes.length; j++) {
                    if (!this.isValidNote(notes[j]))
                        throw new Error("Invalid note '" + notes[j] + "'. Notes can be C D E F G A B C5");
                    if (notes[j] != "-") {
        ...
        FieldCustomMelody.prototype.onNoteSelect = function (row, col) {
            var selectedNote = this.cells[row][col];
        ...
        FieldCustomMelody.prototype.updateGridDisplay = function () {
